        ...
        <div className="bg-red-900/50 border border-red-500 text-red-200 p-4 rounded-lg space-y-4" role="alert">
            ...
            {isQuotaError && (
                <div className="bg-yellow-900/30 border border-yellow-500/50 text-yellow-200 p-3 rounded-md text-sm">
                    ...
                    <p className="mt-1">
                        You've exceeded your generation quota for now. You can continue for free on the official Gemini website. We'll copy the last attempted prompt for you.
                    </p>
                    <button
                    ...
                    >
                        Continue on Gemini Web (Free) &rarr;
                    </button>
                </div>
            )}
